                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex gap-2">
                                        <select
                                            ...
                                            className="flex-1 px-4 py-2 rounded-xl bg-white/5 border border-white/10 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-colors [&>option]:bg-background [&>option]:text-foreground"
                                        >
